var store = [{
        ...
        "excerpt":"Índice y Estructura Principal Instalación del Sistema Operativo Instalación de Software de Virtualización Configuración de la Máquina Virtual en VMware Instalación del Sistema Operativo en la Máquina Virtual Configuración Inicial Instalación y Configuración de BSPWM y SXHKD Instalación de Dependencias Instalación de BSPWM y SXHKD Instalación y Configuración de Kitty...","categories": ["Configuración","Personalización"],
        "tags": ["Linux","Personalización"],
        "url": "http://localhost:4000/como-crear-un-sistema-linux/",
        "teaser":"http://localhost:4000/assets/images/ruyztz/ruyzIOS.png"},{
        "title": "WiFi Hacking: Fuerza Bruta y Métodos Adicionales",
        "excerpt":"Hacking WiFi: Fuerza Bruta y Métodos Adicionales Este artículo detalla los pasos básicos para hackear una red WiFi mediante un ataque de fuerza bruta utilizando Aircrack-ng y describe métodos adicionales para obtener la contraseña. Pasos para hackear una red WiFi 1. Conectar la antena. 2. Instalar Aircrack-ng: sudo apt install...","categories": ["Seguridad","Hacking"],
        ...
        "teaser":"http://localhost:4000/assets/images/htb/beep/beeplogo.png"},{
